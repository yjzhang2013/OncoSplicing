...
fileDir <- "/home/webdata/spliceseq/newAdd/"
outDir <- "/home/webdata/spliceseq/newAdd/pancox/"

fileName <- paste(fileDir,"spliceseq_ase_all_cancertype_",survType,".rds",sep="")
infoAS <- readRDS(file=fileName)

aseAll <- read.csv(file="/home/u1357/webdata/spliceseq/newAdd/spliceseq_pancan_info.csv")
aseAll$idType <- aseAll$Splice_Event
